...
%\subsubsection{Minimum triangulation sampling}
...
%\subsection{Simplical constructions}



%\subsection{Triangulation methods} \label{sec:triangle}
%\subsubsection{Delaunay triangulation of Sobol points}
...
%\subsection{Properties of complex and invariance theorem}
%\subsection{Homomorphisms to mod 2 homology groups}
